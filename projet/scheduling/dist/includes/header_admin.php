            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                 ...
                 <li class="">
                    <!-- Menu Toggle Button -->
                   <a href="home.php" class="" style="font-size:14px"><i class="glyphicon glyphicon glyphicon-th"></i> Class Schedule</a>
                  </li>
                  <!-- Tasks Menu -->
                  <!-- Tasks Menu -->
                 <li class="">
                      ...
                      <li>
                        ...
                        <ul class="menu">
						  <li><!-- start notification -->
                            <a href="class.php">
                              <i class="glyphicon glyphicon-indent-left text-green"></i> Class
                            </a>
                          </li><!-- end notification -->
						 
                          <li><!-- start notification -->
                            <a href="room.php">
                              <i class="glyphicon glyphicon-home text-green"></i> Salle
                            </a>
                          </li><!-- end notification -->
                        ...
                        <ul class="menu">
						  ...
						  <li><!-- start notification -->
                            <a href="department.php">
                              <i class="glyphicon glyphicon glyphicon-list text-green"></i> Department
                            </a>
                          </li><!-- end notification -->
              <li><!-- start notification -->
                            <a href="program.php">
                              <i class="glyphicon glyphicon glyphicon-folder-close text-green"></i> Program
                            </a>
                          </li><!-- end notification -->
						  ...
						  <li><!-- start notification -->
                            <a href="sy.php">
                              <i class="glyphicon glyphicon glyphicon-time text-green"></i> School Year
                            </a>
                          </li><!-- end notification -->
                  ...
                  <!-- Tasks Menu -->
					       <li class="">
                    <!-- Menu Toggle Button -->
                   <a href="settings.php" style="color:;" class="dropdown-toggle">
